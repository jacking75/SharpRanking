...
namespace RtRankingLib.RedBlackTree
{
	public partial class RedBlackTreeWithStats<TElement> : ICollection<TElement>, ICloneable//, IOrderedQueryable<TElement>
	{
		...
		public Node RealRootNode
		{
			get
			{
				return BaseRootNode.LeftNode;
			}
			set
			{
				BaseRootNode.LeftNode = value;
			}
		}
		...
		{
			get {
				return BaseRootNode.LeftMostNode.Value;
			}
		}
		...
		{
			get {
				return BaseRootNode.PreviousNode.Value;
			}
		}
